...
require 'vendor/phpmailer/phpmailer/src/SMTP.php';
    ...
    function sendEmail($to, $subject, $messageContent){
        ...
        $mail->Username   = "ptelljove.cf@iesesteveterradas.cat";
        $mail->Password   = "Polloptell99";
        $mail->IsHTML(true);
        $mail->AddAddress($to);
        $mail->SetFrom("ptelljove.cf@iesesteveterradas.cat", "Pol Tell");

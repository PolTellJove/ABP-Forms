...
function getOptionsOfActiveQuestions(){
    $startSession = connToDB()->prepare("SELECT * FROM `question_option` qo INNER JOIN abp_poll.question q on qo.questionID = q.ID INNER JOIN abp_poll.option o on qo.optionID=o.ID WHERE q.active = 0;");
